...
test_response_model = colour_vision_ns.model('ColourVisionTestResponse', {
    ...
    'user_answers': fields.List(fields.String, description='User answers for each plate'),
    'correct_answers': fields.List(fields.String, description='Correct answers for each plate'),
