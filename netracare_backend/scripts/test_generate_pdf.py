...
def main():
    ...
    report = {
        ...
        'findings': {'visual_acuity': 'Not Recorded', 'colour_vision': 'Not Recorded', 'blink_fatigue': 'Not Recorded', 'pupil_reflex': 'Not Recorded'},
        'test_counts': {'visual_acuity': 0, 'colour_vision': 0, 'blink_fatigue': 0, 'pupil_reflex': 0},
    ...
    if WEASY_AVAILABLE and HTML is not None:
        ...
        buf = generate_pdf_from_report(type('U', (), {'id': 1, 'name': 'Test User'}), report['ai_report_text'], 85.0, {'visual_acuity': 85}, generation_date)
        with open(out_path, 'wb') as f:
