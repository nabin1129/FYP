...
class Notification(db.Model):
    ...
    )  # consultation_request, test_result, reminder, etc.
    ...
    def create_consultation_request(
        doctor_id: int, patient_id: int, consultation_id: int, patient_name: str
    ):
    ...
    @staticmethod
    def create_consultation_scheduled(
        patient_id: int, consultation_id: int, doctor_name: str, scheduled_date: str
    ):
    ...
    @staticmethod
    def create_test_shared(
        doctor_id: int, patient_id: int, test_type: str, patient_name: str
    ):
    ...
    def create_message_notification(
        recipient_type: str, recipient_id: int, sender_name: str, consultation_id: int
    ):
    ...
    @staticmethod
    def create_review_complete(
        patient_id: int, report_id: int, status: str, doctor_name: str
    ):
