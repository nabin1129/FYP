...
class MedicalRecord(db.Model):
    ...
    doctor_id = db.Column(
        db.Integer, db.ForeignKey("doctors.id"), nullable=False, index=True
    )
    ...
    )  # scan_report, prescription, lab_report, clinical_note, test_result
    ...
    creator = db.relationship(
        ...
        backref=db.backref("created_medical_records", lazy="dynamic"),
    )
    updater = db.relationship(
        "Doctor",
        foreign_keys=[updated_by_id],
        backref=db.backref("updated_medical_records", lazy="dynamic"),
    )
    deleter = db.relationship(
        "Doctor",
        foreign_keys=[deleted_by_id],
        backref=db.backref("deleted_medical_records", lazy="dynamic"),
    )
