...
class MedicalRecordService:
    ...
    def create_record(
        self, *, doctor_id: int, patient_id: int, created_by_id: int, data: dict
    ) -> MedicalRecord:
    ...
    def update_record(
        self, record: MedicalRecord, *, updated_by_id: int, data: dict
    ) -> MedicalRecord:
        for field in (
            "record_type",
            "title",
    ...
    def soft_delete_record(
        self, record: MedicalRecord, *, deleted_by_id: int
    ) -> MedicalRecord:
    ...
    def restore_record(
        self, record: MedicalRecord, *, restored_by_id: int
    ) -> MedicalRecord:
