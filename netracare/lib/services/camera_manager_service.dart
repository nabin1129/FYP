...
class CameraManagerService {
  ...
  Future<void> initialize({
    ...
    try {
      ...
      // Select camera
      _currentCameraIndex = useFrontCamera ? 1 : 0;
      if (_currentCameraIndex >= _cameras!.length) {
        _currentCameraIndex = 0; // Fallback to back camera
      }
      ...
      debugPrint('CameraManager: Initialized ${useFrontCamera ? 'front' : 'back'} camera');
    } catch (e) {
