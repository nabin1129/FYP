...
class DistanceDetectionService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      debugPrint('DistanceDetection: Face detector initialized');
    } catch (e) {
  ...
  Future<void> startDetection() async {
    ...
    if (!_cameraManager.isReady) {
      throw Exception('Camera not ready. Initialize CameraManager first.');
    }
    ...
    try {
      ...
      debugPrint('DistanceDetection: Detection started');
    } catch (e) {
      _isDetecting = false;
