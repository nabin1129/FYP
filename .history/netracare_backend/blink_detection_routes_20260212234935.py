...
# Try to import dlib if available
try:
    import dlib
    ...
    print("   Blink detection will use fallback method")
...
class FrameAnalysis(Resource):
    ...
    def post(self, current_user):
        ...
        try:
            ...
            # If dlib is not available, use fallback heuristic
            if not DLIB_AVAILABLE:
                ...
                return {
                    ...
                    'message': 'Using fallback detection (dlib not available)'
                }, 200
