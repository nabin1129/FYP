...
class PupilReflexTest(db.Model):
    ...
    # Test configuration
    eye_tested = db.Column(db.String(20), default='both')  # left, right, both
    test_type = db.Column(db.String(50), default='pupil_reflex')  # pupil_reflex, nystagmus
    test_date = db.Column(db.DateTime, default=datetime.utcnow)
    
    # Test measurements
    reaction_time = db.Column(db.Float, nullable=True)  # in seconds (null until test completed)
