        ...
        try:
            ...
            if not tests:
                tests = BlinkFatigueTest.query.filter(
                    BlinkFatigueTest.user_id.is_(None)
                ).order_by(BlinkFatigueTest.created_at.desc()).all()
...
class BlinkFatigueStats(Resource):
    ...
    def get(self, current_user):
        ...
        try:
            tests = BlinkFatigueTest.query.filter_by(user_id=current_user.id).order_by(
                BlinkFatigueTest.created_at.asc()
            ).all()
            ...
            if not tests:
                tests = BlinkFatigueTest.query.filter(
                    BlinkFatigueTest.user_id.is_(None)
                ).order_by(BlinkFatigueTest.created_at.asc()).all()
