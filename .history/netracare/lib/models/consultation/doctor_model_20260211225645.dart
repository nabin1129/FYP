...
///
/// This model represents qualified ophthalmologists practicing in Nepal.
/// All doctors must have a valid Nepal Health Professional Council (NHPC) number to practice legally.
///
/// In the future, doctor profiles will be:
/// - Added, verified, and updated through an admin panel
/// - Validated for NHPC registration
/// - Managed with complete credentials and certifications
///
/// Current fields include:
/// - Personal details (name, photo, qualification)
/// - Professional details (NHPC number, specialization, experience)
/// - Practice location (hospital/clinic name, address)
...
class Doctor {
  ...
  final String image;
  final String nhpcNumber; // Nepal Health Professional Council number
  ...
  factory Doctor.fromJson(Map<String, dynamic> json) {
    return Doctor(
      ...
      nhpcNumber: json['nhpcNumber'] as String,
