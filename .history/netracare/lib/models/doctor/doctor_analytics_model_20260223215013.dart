...
class DoctorAnalytics {
  ...
  static DoctorAnalytics getMockAnalytics() {
    return DoctorAnalytics(
      ...
      testsThisWeek: 12,
      pendingReviews: 3,
      distribution: PatientDistribution(good: 45, attention: 12, critical: 3),
      healthTrend: [
...
class PatientDistribution {
  ...
  Map<String, dynamic> toJson() {
    return {'good': good, 'attention': attention, 'critical': critical};
  }
...
class HealthTrendData {
  ...
  HealthTrendData({required this.month, required this.avgScore});
  ...
  Map<String, dynamic> toJson() {
    return {'month': month, 'avgScore': avgScore};
  }
}
...
class TestTypeStats {
  ...
  Map<String, dynamic> toJson() {
    return {'testType': testType, 'count': count, 'avgScore': avgScore};
  }
}
