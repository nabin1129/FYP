  ...
  static List<MedicalRecord> getMockRecords(String patientId) {
    return [
      MedicalRecord(
        ...
        description: 'Optical coherence tomography scan of retina. Normal findings with no signs of macular degeneration.',
      ...
      MedicalRecord(
        ...
        description: 'Lubricating eye drops for dry eyes. Use 3 times daily for 2 weeks.',
        date: DateTime.now().subtract(const Duration(days: 15)),
        doctorName: 'Dr. Rajesh Kumar Shrestha',
        metadata: {
          'medications': [
            {'name': 'Refresh Tears', 'dosage': '3 times daily', 'duration': '2 weeks'},
          ],
        },
      ),
      MedicalRecord(
        ...
        description: 'Fasting blood sugar test for diabetic retinopathy screening. Results within normal range.',
      ...
      MedicalRecord(
        ...
        description: 'Automated perimetry test. Mild peripheral vision defects noted in left eye.',
  ...
  static List<ClinicalNote> getMockNotes(String patientId) {
    return [
      ClinicalNote(
        ...
        content: 'Patient reports improvement in eye fatigue after following the 20-20-20 rule. Visual acuity stable at 6/6 for both eyes. Continue current management.',
      ...
      ClinicalNote(
        ...
        content: 'New patient presenting with complaints of eye strain and occasional blurred vision. Screen time: 8+ hours daily. Recommended comprehensive eye examination.',
      ...
      ClinicalNote(
        ...
        content: 'Based on recent test results, prescribing lubricating eye drops for dry eye syndrome. Review in 2 weeks. Patient advised to reduce screen brightness and take regular breaks.',
