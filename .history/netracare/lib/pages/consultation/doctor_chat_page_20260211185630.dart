      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.school, 'Qualification', widget.doctor.qualification),
            _buildInfoRow(Icons.local_hospital, 'Working Place', widget.doctor.workingPlace),
            _buildInfoRow(Icons.verified_user, 'NMC Number', widget.doctor.nmcNumber),
            ...
            if (widget.doctor.address != null)
              _buildInfoRow(Icons.location_on, 'Address', widget.doctor.address!),
            const SizedBox(height: AppTheme.spaceMD),
          ],
        ),
      ),
