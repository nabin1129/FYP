...
class _DoctorConsultationPageState extends State<DoctorConsultationPage>
  ...
  Future<void> _loadDoctors() async {
    try {
      final loadedDoctors = await _consultationService.getAvailableDoctorsAsync();
      if (mounted) {
        setState(() {
  ...
  Future<void> _loadConsultations() async {
    try {
      final loadedConsultations =
          await _consultationService.getAllConsultationsAsync();
      if (mounted) {
        setState(() {
  ...
  Future<void> _refreshData() async {
    await _consultationService.refresh();
