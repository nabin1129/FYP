...
class _NystagmusTestPageState extends State<NystagmusTestPage> {
  ...
  Future<void> _startRecording() async {
    if (_cameraController == null || !_cameraController!.value.isInitialized || _isRecordingInProgress) {
    ...
    try {
      ...
      debugPrint('Error starting recording: $e');      _isRecordingInProgress = false;      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
  ...
  Future<void> _stopRecording() async {
    ...
    if (_cameraController == null || !_cameraController!.value.isRecordingVideo || !_isRecordingInProgress) {
      return;
    }
