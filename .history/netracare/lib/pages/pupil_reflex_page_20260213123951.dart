...
import 'nystagmus_test_page.dart';
import 'combined_pupil_test_page.dart';
  ...
  Widget _introUI() {
    return Column(
      ...
      children: [
        ...
        const Text(
          "Choose a test to evaluate your pupil reflexes and eye movements.",
          textAlign: TextAlign.center,
          style: TextStyle(fontSize: 14, color: Color(0xFF6b7280), height: 1.5),
        ),
        const SizedBox(height: 24),
        
        // Basic Pupil Reflex Test Card
        _testOptionCard(
          icon: Icons.flash_on,
          title: 'Pupil Reflex Test',
          description: 'Basic test to evaluate pupil response to light',
          onTap: proceed,
        ),
        
        const SizedBox(height: 12),
        Combined Test Card (NEW)
        _testOptionCard(
          icon: Icons.visibility,
          title: 'Combined Test',
          description: 'Test pupil reflex and nystagmus together in one session',
          isNew: true,
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const CombinedPupilTestPage()),
            );
          },
        ),
        ...
        // Nystagmus Detection Test Card
        _testOptionCard(
          icon: Icons.remove_red_eye,
          title: 'Nystagmus Detection',
          description: 'Advanced test to detect involuntary eye movements': 'Advanced test to detect involuntary eye movements',
          isNew: true,
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const NystagmusTestPage()),
            );
          },
        ),
      ],
