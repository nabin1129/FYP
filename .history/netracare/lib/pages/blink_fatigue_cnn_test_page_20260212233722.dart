...
class _BlinkFatigueCNNTestPageState extends State<BlinkFatigueCNNTestPage> {
  ...
  Widget _buildResults() {
    ...
    final prediction = predictionResult!['prediction'] as String? ?? 'notdrowsy';
    final confidence = (predictionResult!['confidence'] as num?)?.toDouble() ?? 0.0;
    final fatigueLevel = predictionResult!['fatigue_level'] as String? ?? 'Unknown';
    final alertTriggered = predictionResult!['alert_triggered'] as bool? ?? false;
