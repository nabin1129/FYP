...
class _ResultsReportPageState extends State<ResultsReportPage>
      ...
      setState(() {
        ...
        _blinkFatigueTests =
            (blinkFatigueData?['tests'] as List?)
                ...
                .toList() ??
            [];
        _pupilReflexTests = []; // Pupil reflex tests (simulation - not saved to backend yet)
  ...
  Widget _buildPupilReflexTestCard(Map<String, dynamic> test) {
    ...
    final reactionTime = (test['reaction_time'] ?? test['pupil_reaction_time'] ?? 0.0).toDouble();
    final amplitude = test['constriction_amplitude'] ?? test['amplitude'] ?? 'Normal';
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Expanded(
                child: _buildDetailItem('Amplitude', amplitude),
              ),
            ],
          ),
          const SizedBox(height: 8),
