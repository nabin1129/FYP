    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTestResultCard(
            'Blink Rate',
            testSummary.blinkRate != null ? '${testSummary.blinkRate} bpm' : 'Not taken',
        ...
        children: [
          Expanded(
            child: ElevatedButton.icon(
              onPressed: () => _navigateToAddRecord(MedicalRecordType.scanReport),
          ...
          Expanded(
            child: ElevatedButton.icon(
              onPressed: () => _navigateToAddRecord(MedicalRecordType.prescription),
          ...
          Expanded(
            child: ElevatedButton.icon(
              onPressed: () => _navigateToAddRecord(MedicalRecordType.labReport),
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => AddClinicalNotePage(patientId: widget.patientId),
                  ),
                ).then((_) => _loadData());
              },
