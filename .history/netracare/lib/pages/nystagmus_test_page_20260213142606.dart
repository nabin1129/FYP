            ...
            child: Column(
              ...
              children: [
                ...
                _buildInstructionItem(
                  '1',
                  'Position your face 30-40cm from the camera',
                ),
                _buildInstructionItem('2', 'Look directly at the camera'),
                _buildInstructionItem('3', 'Keep your eyes open and relaxed'),
                _buildInstructionItem(
                  '4',
                  'The test will record for 10-15 seconds',
                ),
                _buildInstructionItem(
                  '5',
                  'Try to keep your head still during recording',
                ),
              ],
            ),
          ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildResultRow(
                    'Type',
                    nystagmusType?.toUpperCase() ?? 'N/A',
                  ),
                  const Divider(height: 24),
                  _buildResultRow(
                    'Severity',
                    nystagmusSeverity?.toUpperCase() ?? 'N/A',
                  ),
                  const Divider(height: 24),
                  _buildResultRow(
                    'Confidence',
...
enum TestPhase { instructions, starting, recording, processing, results, error }
